...
对于显示“403”的博友，你需要在你的防火墙/WAF/安全规则里放行用户代理 `User-Agent` 特征：**包含** (contain) `(link-checker/1.0; +https://github.com/xaoxuu/links-checker)`（可访问性检测）和 `(feed-post-parser/1.0; +https://github.com/xaoxuu/feed-posts-parser)`（Feed 源抓取），并且将其优先于其他阻拦规则。这参考了 [Allowlisting Instatus checks](https://instatus.com/help/monitoring) 的实践。

[订阅源一定要能订阅](https://blog.zhilu.site/2025/unpopular-blog-tech#twikoo)

## 本站信息

你也可以直接添加我为你的友链而不需要事先联系！当然，如果你愿意告知我一声（在提 issue 前后都行！）自然是更好的 :)
